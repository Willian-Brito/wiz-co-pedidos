    ...
    public void Configure(EntityTypeBuilder<Pedido> builder)
    {
        ...
        builder.HasData(
            ...
            new
            {
                ...
                DataCriacao = DateTime.Now.AddDays(-18),
            ...
            new
            {
                ...
                DataCriacao = DateTime.Now.AddDays(-17),
            ...
            new
            {
                ...
                DataCriacao = DateTime.Now.AddDays(-14),
                Status = StatusPedido.Novo,
                ValorTotal = 1100m
            },
            new
            {
                ...
                DataCriacao = DateTime.Now.AddDays(-13),
                Status = StatusPedido.Pago,
                ValorTotal = 1800m
            },
            new
            ...
            new
            {
                ...
                DataCriacao = DateTime.Now.AddDays(-11),
                Status = StatusPedido.Novo,
                ValorTotal = 3200m
            },
            new
